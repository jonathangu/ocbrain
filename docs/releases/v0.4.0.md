...
pack, and local grading can target only that selection. Pilot preparation
refuses to train unless 100% of the selected pack has a local grade and the
passing pack contains at least 1,000 skill, 300 authentic voice, and 200
judgment examples. The original twenty evaluations remain a byte-for-byte
sentinel, and the expanded protocol supports blind base/tuned/Jonathan/frontier
comparison.
...
On 2026-07-10, the unchanged frozen retrieval file
(`df34ff2e2350f644c857cf3bebfd5ea295dc2729b4ed4393ca53a3c681db684e`)
reached 100/100 top-five relevance on the default local brain. A 1.9 GB online
...
already good enough to train. The deterministic selected pack contains 2,000
skill, 500 voice, and 300 judgment candidates; local grading and its corpus gate
remain mechanically visible.

The local blind judge passed the unchanged eight human labels 8/8 with
`gemma4:31b` at the fixed 90% gate. The final source suite passed 516 tests.
